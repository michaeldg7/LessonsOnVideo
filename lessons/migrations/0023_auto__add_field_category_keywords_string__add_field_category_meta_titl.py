...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.keywords_string'
        db.add_column(u'lessons_category', u'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Category.meta_title'
        db.add_column(u'lessons_category', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.meta_description'
        db.add_column(u'lessons_category', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.keywords_string'
        db.delete_column(u'lessons_category', u'keywords_string')

        # Deleting field 'Category.meta_title'
        db.delete_column(u'lessons_category', 'meta_title')

        # Deleting field 'Category.meta_description'
        db.delete_column(u'lessons_category', 'meta_description')
