...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related_videos on 'VideoLesson'
        m2m_table_name = db.shorten_name(u'lessons_videolesson_related_videos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_videolesson', models.ForeignKey(orm[u'lessons.videolesson'], null=False)),
            ('to_videolesson', models.ForeignKey(orm[u'lessons.videolesson'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_videolesson_id', 'to_videolesson_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_videos on 'VideoLesson'
        db.delete_table(db.shorten_name(u'lessons_videolesson_related_videos'))
