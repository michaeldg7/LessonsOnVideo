...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.ad_script'
        db.add_column(u'lessons_category', 'ad_script',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.ad_script'
        db.delete_column(u'lessons_category', 'ad_script')
    ...
    models = {
        ...
        u'lessons.videolesson': {
            ...
            'uploaded_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 6, 0, 0)'}),
