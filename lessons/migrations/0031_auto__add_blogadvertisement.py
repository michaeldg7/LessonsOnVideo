...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogAdvertisement'
        db.create_table(u'lessons_blogadvertisement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('mptt.fields.TreeForeignKey')(to=orm['blog.BlogPost'])),
            ('ad_script', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'lessons', ['BlogAdvertisement'])


    def backwards(self, orm):
        # Deleting model 'BlogAdvertisement'
        db.delete_table(u'lessons_blogadvertisement')
    ...
    models = {
        ...
        u'lessons.blogadvertisement': {
            ...
            'ad_script': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('mptt.fields.TreeForeignKey', [], {'to': u"orm['blog.BlogPost']"})
        },
        u'lessons.category': {
        ...
        u'lessons.product': {
            ...
            'category': ('mptt.fields.TreeForeignKey', [], {'to': u"orm['lessons.Category']"}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 7, 0, 0)'}),
        ...
        u'lessons.videolesson': {
            ...
            'uploaded_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 7, 0, 0)'}),
