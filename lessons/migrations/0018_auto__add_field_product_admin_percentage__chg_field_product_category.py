...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.admin_percentage'
        db.add_column(u'lessons_product', 'admin_percentage',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=7, decimal_places=2),
                      keep_default=False)


        # Changing field 'Product.category'
        db.alter_column(u'lessons_product', 'category_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['lessons.Category']))

    def backwards(self, orm):
        # Deleting field 'Product.admin_percentage'
        db.delete_column(u'lessons_product', 'admin_percentage')


        # Changing field 'Product.category'
        db.alter_column(u'lessons_product', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lessons.Category']))
    ...
    models = {
        ...
        u'lessons.product': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 17, 0, 0)'}),
        ...
        u'lessons.videolesson': {
            ...
            'uploaded_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 17, 0, 0)'}),
