...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoLesson.comments_count'
        db.add_column(u'lessons_videolesson', u'comments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoLesson.comments_count'
        db.delete_column(u'lessons_videolesson', u'comments_count')
    ...
    models = {
        ...
        u'lessons.product': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 18, 0, 0)'}),
        ...
        u'lessons.videolesson': {
            ...
            'uploaded_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 18, 0, 0)'}),
