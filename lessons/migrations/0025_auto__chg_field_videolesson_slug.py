...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoLesson.slug'
        db.alter_column(u'lessons_videolesson', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'VideoLesson.slug'
        db.alter_column(u'lessons_videolesson', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))
    ...
    models = {
        ...
        u'lessons.category': {
            ...
            'ad_script': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
