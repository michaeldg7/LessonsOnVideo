...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lessons_homepage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ad_top', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('ad_bottom_left', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('ad_bottom_right', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'lessons', ['HomePage'])


    def backwards(self, orm):
        # Deleting model 'HomePage'
        db.delete_table(u'lessons_homepage')
