...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lessons_homepagevideo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('mptt.fields.TreeForeignKey')(to=orm['lessons.Category'])),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lessons.VideoLesson'])),
        ))
        db.send_create_signal(u'lessons', ['HomePageVideo'])


    def backwards(self, orm):
        # Deleting model 'HomePageVideo'
        db.delete_table(u'lessons_homepagevideo')
    ...
    models = {
        ...
        u'lessons.blogadvertisement': {
            'Meta': {'object_name': 'BlogAdvertisement'},
            'ad_script': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'lessons.homepage': {
            ...
            'ad_bottom_left': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ad_bottom_right': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ad_top': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'lessons.homepagevideo': {
            'Meta': {'object_name': 'HomePageVideo'},
            'category': ('mptt.fields.TreeForeignKey', [], {'to': u"orm['lessons.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lessons.VideoLesson']"})
        },
        u'lessons.product': {
            ...
            'category': ('mptt.fields.TreeForeignKey', [], {'to': u"orm['lessons.Category']"}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 23, 0, 0)'}),
        ...
        u'lessons.videolesson': {
            ...
            'uploaded_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 23, 0, 0)'}),
