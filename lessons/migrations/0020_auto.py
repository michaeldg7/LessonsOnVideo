...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related_products on 'VideoLesson'
        m2m_table_name = db.shorten_name(u'lessons_videolesson_related_products')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('videolesson', models.ForeignKey(orm[u'lessons.videolesson'], null=False)),
            ('product', models.ForeignKey(orm[u'lessons.product'], null=False))
        ))
        db.create_unique(m2m_table_name, ['videolesson_id', 'product_id'])


    def backwards(self, orm):
        # Removing M2M table for field related_products on 'VideoLesson'
        db.delete_table(db.shorten_name(u'lessons_videolesson_related_products'))
