...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lessons_productfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lessons.Product'])),
            ('file_item', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'lessons', ['ProductFile'])


    def backwards(self, orm):
        # Deleting model 'ProductFile'
        db.delete_table(u'lessons_productfile')
