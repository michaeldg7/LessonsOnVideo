...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for lesson in orm['lessons.VideoLesson'].objects.all():
            backend = detect_backend(lesson.video)
            lesson.backend = backend.backend
            lesson.thumbnail = backend.thumbnail
            lesson.save()
