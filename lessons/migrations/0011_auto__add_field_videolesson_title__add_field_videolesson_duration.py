...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoLesson.title'
        db.add_column(u'lessons_videolesson', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoLesson.duration'
        db.add_column(u'lessons_videolesson', 'duration',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoLesson.title'
        db.delete_column(u'lessons_videolesson', 'title')

        # Deleting field 'VideoLesson.duration'
        db.delete_column(u'lessons_videolesson', 'duration')
