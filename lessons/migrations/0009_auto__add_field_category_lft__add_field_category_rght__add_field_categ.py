...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lessons_category', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Category.rght'
        db.add_column(u'lessons_category', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Category.tree_id'
        db.add_column(u'lessons_category', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Adding field 'Category.level'
        db.add_column(u'lessons_category', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)


        # Changing field 'Category.parent'
        db.alter_column(u'lessons_category', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['lessons.Category']))

    def backwards(self, orm):
        # Deleting field 'Category.lft'
        db.delete_column(u'lessons_category', u'lft')

        # Deleting field 'Category.rght'
        db.delete_column(u'lessons_category', u'rght')

        # Deleting field 'Category.tree_id'
        db.delete_column(u'lessons_category', u'tree_id')

        # Deleting field 'Category.level'
        db.delete_column(u'lessons_category', u'level')


        # Changing field 'Category.parent'
        db.alter_column(u'lessons_category', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lessons.Category'], null=True))
