...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoLesson.keywords_string'
        db.add_column(u'lessons_videolesson', u'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'VideoLesson.meta_title'
        db.add_column(u'lessons_videolesson', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VideoLesson.meta_description'
        db.add_column(u'lessons_videolesson', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoLesson.keywords_string'
        db.delete_column(u'lessons_videolesson', u'keywords_string')

        # Deleting field 'VideoLesson.meta_title'
        db.delete_column(u'lessons_videolesson', 'meta_title')

        # Deleting field 'VideoLesson.meta_description'
        db.delete_column(u'lessons_videolesson', 'meta_description')
    ...
    models = {
        ...
        u'lessons.product': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 30, 0, 0)'}),
        ...
        u'lessons.videolesson': {
            ...
            'uploaded_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 30, 0, 0)'}),
