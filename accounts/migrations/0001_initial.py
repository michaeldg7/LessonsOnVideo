...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_registrationtoken', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'accounts', ['RegistrationToken'])


    def backwards(self, orm):
        # Deleting model 'RegistrationToken'
        db.delete_table(u'accounts_registrationtoken')


    models = {
        u'accounts.registrationtoken': {
